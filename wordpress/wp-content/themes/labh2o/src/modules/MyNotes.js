...
class MyNotes {
  ...
  // find the textareas elements and remove the readonly attributes to make them editable
  editNote(e) {
    const thisNote = this.findNearestParentLi(e.target)
   // alternate buttons edit and cancel
    // at first glance none of the elements will contain atrribute state and it will evaluate to false
  ...
  async updateNote(e) {
    const thisNote = this.findNearestParentLi(e.target)
 //look inside UL for the value title and content of textarea
    var ourUpdatedPost = {
